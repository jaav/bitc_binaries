			...
			<c:forEach var="item" items="${list}" varStatus="loop">
				...
				<li>
					<div class="bfo_list_img">
						...
						<c:if
							test="${contentType eq 'ContentGuidedTour' && item.boxofficeId != null && item.boxofficeId > 0 && (item.officeBookingURL==null || '' eq item.officeBookingURL)}">
							<p style="clear: both; margin:0;"></p>

							<p class="boxoffice_list_button boxoffice_list_button_${culture.language}"><a
								href="http://ticketing.visitbrussels.be/${culture.language}/calendar/init/${item.boxofficeId}" target="_blank"></a>
							</p>
						</c:if>
						<c:if test="${contentType eq 'ContentGuidedTour' && item.officeBookingURL != null}">
							<p style="clear: both; margin:0;"></p>

							<p class="boxoffice_list_button boxoffice_list_button_${culture.language}">
								<a href="javascript:openIFrame('${item.officeBookingURL}')"></a>
							</p>
						</c:if>
