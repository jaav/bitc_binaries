...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${static}/minisite/css/${waParam.name}.css" media="screen, projection"/>
	<% //JS IMPORT %>
    ...
    <c:if test="${not empty waParam.group && not empty waParam.id}">
		...
		<c:set var="og_url" value="${config['URL']}${context}/${site}/${module}/${action}/group/${waParam.group}/id/${waParam.id}/name/${waParam.name}.do"/>  
