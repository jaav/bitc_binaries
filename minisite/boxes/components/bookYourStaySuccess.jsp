 ...
 <div>
    	<div class="book_stay"> <img src="${static}/front/img/en/title_book_stay.gif" alt="Book your stay"/>
            ...
            <span id="tfv_room_type_${waCompParam.zone}">
	              <label for="f_page"><wa:mls>Type de chambre :</wa:mls></label><br />
	              ...
	              <img src="${static}/front/img/ml/ok.png" class="validMsg" alt="ok icon" /> <img src="${static}/front/img/ml/erreur.png" class="errorMsg" alt="error icon" />
              ...
              <span id="tfv_date_begin_${waCompParam.zone}">
	              ...
	              <img src="${static}/front/img/ml/ok.png" class="validMsg" style="border: 0;" alt="ok icon" /> <img src="${static}/front/img/ml/erreur.png" class="errorMsg" style="border: 0;" alt="error icon" />
				  <!-- <div class="selectRequiredMsg">Veuillez faire un choix</div>-->
              </span>
              ...
              <span id="tfv_date_end_${waCompParam.zone}">
	              ...
	              <img src="${static}/front/img/ml/ok.png" class="validMsg" style="margin:4px 0 0 5px; border: 0;" alt="ok icon" /> <img src="${static}/front/img/ml/erreur.png" class="errorMsg" style="margin:4px 0 0 5px; border: 0;" alt="error icon" />
				  <!--<div class="selectRequiredMsg">Veuillez faire un choix</div>-->
              </span>
              <div class="clr"></div>
...
function compareDates(LeParam1,LeParam2){
...
function checkDate(){
    ...
    if(day_begin != '' && month_begin != '' && day_end != '' && month_end != ''){
		//alert('fill')
		if(!compareDates(begindate,enddate)){
			return true;		
		}
    } else {
    	//alert('not fill')
...
var spryRoomType = new Spry.Widget.ValidationSelect("tfv_room_type_${waCompParam.zone}", {validateOn:["change"]});
