	...
	<div id="searchBox" style="width:300px">
		...
		<div class="content">
			<form name="searchForm" id="searchForm" action="${context}/${site}/${module}/${action}.do${filterString}">
				...
				<div>
					<label for="s_gourmet"><wa:mls>gourmet</wa:mls></label>
					<input type="radio"<c:if test="${waParam.s_gourmet=='0'}"> checked="checked"</c:if> value="0" name="s_gourmet" style="margin-left:50px;"/><wa:mls>No</wa:mls>
					<input type="radio"<c:if test="${waParam.s_gourmet=='1'}"> checked="checked"</c:if> value="1" name="s_gourmet"/><wa:mls>Yes</wa:mls>
				</div>
				<div>
					<label for="s_breakfast"><wa:mls>breakfast</wa:mls></label>
					<input type="radio"<c:if test="${waParam.s_breakfast=='0'}"> checked="checked"</c:if> value="0" name="s_breakfast" style="margin-left:50px;"/><wa:mls>No</wa:mls>
					<input type="radio"<c:if test="${waParam.s_breakfast=='1'}"> checked="checked"</c:if> value="1" name="s_breakfast"/><wa:mls>Yes</wa:mls>
				</div>
				<div>
					<label for="s_night"><wa:mls>night</wa:mls></label>
					<input type="radio"<c:if test="${waParam.s_night=='0'}"> checked="checked"</c:if> value="0" name="s_night" style="margin-left:50px;"/><wa:mls>No</wa:mls>
					<input type="radio"<c:if test="${waParam.s_night=='1'}"> checked="checked"</c:if> value="1" name="s_night"/><wa:mls>Yes</wa:mls>
				</div>
...
<!--floatLeft:end-->
<h2><wa:mls>contentRestaurant${waParam.group}</wa:mls></h2>
<div id="list">
	<div id="mask">
		<table cellspacing=0 cellpadding=0>
			...
			<c:forEach var="item" items="${list}" varStatus="loop">
				<tr class="line${((loop.count+1)%2)+1}">
					...
					<td class="center id"><a href="${context}/${site}/contentRestaurant/editItem/id/${item.id}.do" title="<wa:mls>Edit id</wa:mls>">${item.id}</a></td>
