...
<!--floatLeft:end-->
<h2><wa:mls>Catalog Price</wa:mls></h2>
<div id="list">
	<div id="mask">
		<table cellspacing=0 cellpadding=0>
			...
			<c:forEach var="item" items="${list}" varStatus="loop">
				<tr class="line${((loop.count+1)%2)+1}">
					...
					<td class="center titleDefault">${item.titleDefault}&nbsp;</td>
					...
					<td class="center value">${item.value}&nbsp;</td>
				</tr>
			</c:forEach>
		</table>
	</div>
...
<div id="fieldList">
		...
		<div>
			<input name="titleDefault" id="c_titleDefault" type="checkbox" value="1" checked="checked"/>
			<label><wa:mls>titleDefault</wa:mls></label>
		</div>
		<div>
			...
			<div>
			<input name="value" id="c_value" type="checkbox" value="1" checked="checked"/>
			<label><wa:mls>value</wa:mls></label>
		</div>
