		...
		<c:if test="${list!=null}">
		    ...
		    <table class="table" cellspacing=0 cellpadding=0>
				<tr class="header">
					...
					<td class="cellheader">Ressource</td>
					<td class="cellheader">View</td>
				</tr>
				<c:forEach var="item" items="${list}" varStatus="loop">
					<tr class="line${((loop.count+1)%2)+1}">
						<td class="cell">${item.id}</td>
						<td class="cell">${item.ressource}</td>
						<td class="cell">
							<wa:link URI="admin/adminressources/editItem/id/${item.id}" allParams="true" backURL="true">
			...
			<div class="pagesContainer floatLeft">
			    <div class="blackbtncontainer">
				    ...
				    <div class="blackbtn">
				    	<wa:link URI="admin/adminressources/newItem">
				    	New item
				    	</wa:link>
				    </div>
