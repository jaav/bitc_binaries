						...
						<div id="searchBox">
							...
							<div class="content">
								<form name="searchForm" id="searchForm" action="${context}/${site}/${module}/${action}.do${filterString}">
									...
									<div>
										<label for="s_tag"><wa:mls>tag</wa:mls></label>
										<input name="s_tag" type="text" <c:choose><c:when test="${waParam.s_tag!=null}">value="${waParam.s_tag}"</c:when><c:otherwise>value=""</c:otherwise></c:choose>/>
									</div>
									<!-- SEARCH BUTTONS -->
							...
							<table cellspacing=0 cellpadding=0>
								...
								<tr class="header">
									...
									<td class="center createdOn">
										...
										<wa:link URI="${URI}" allParams="true">
											...
											<wa:param name="orderDir" value="${orderDir}" />
											<wa:exceptParam name="orderBy"/>
											<wa:param name="orderBy" value="tag" />
										</wa:link>
									</td>
								</tr>
								...
								<c:forEach var="item" items="${list}" varStatus="loop">
									<tr class="line${((loop.count+1)%2)+1}">
										...
										<td class="right id"><a href="${context}/${site}/iLike/editItem/id/${item.id}.do" title="<wa:mls>view</wa:mls>">${item.id}&nbsp;</a></td>
				...
				<div id="fieldList">
					<div>
						<input name="id" id="cidd" type="checkbox" value="1" checked="checked"/>
					...
					<div>
						<input name="tag" id="c_tag" type="checkbox" value="1" checked="checked"/>
						<label><wa:mls>tag</wa:mls></label>
					</div>
				</div>
