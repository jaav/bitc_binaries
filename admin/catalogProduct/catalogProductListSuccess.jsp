...
<!--floatLeft:end-->
<h2><wa:mls>CatalogProduct${waParam.group}</wa:mls></h2>
<div id="list">
	<div id="mask">
		<table cellspacing=0 cellpadding=0>
			<tr class="header">
				...
				<td class="center checkbox">
					...
					<td class="center partner">
						<wa:link URI="${URI}" allParams="true">
							<wa:mls>partner</wa:mls>
							<wa:exceptParam name="page"/>
							<wa:param name="page" value="1" />
							<wa:exceptParam name="orderDir"/>
							<wa:param name="orderDir" value="${orderDir}" />
							<wa:exceptParam name="orderBy"/>
							<wa:param name="orderBy" value="partner" />
						</wa:link>			
					</td>
					<td class="center category">
						<wa:link URI="${URI}" allParams="true">
							...
							<wa:param name="orderDir" value="${orderDir}" />
							<wa:exceptParam name="orderBy"/>
							<wa:param name="orderBy" value="category" />
						</wa:link>			
					</td>
			...
			<c:forEach var="item" items="${list}" varStatus="loop">
				<tr class="line${((loop.count+1)%2)+1}">
					...
					<td class="center id"><a href="${context}/${site}/catalogProduct/editItem/id/${item.id}.do" title="<wa:mls>Edit id</wa:mls>">${item.id}</a></td>
					...
					<td class="center publishContent">${item.publishContent.id}&nbsp;</td>
					<td class="center partner"><a href="${context}/${site}/contentPlace/editItem/id/${item.partner.id}.do" title="<wa:mls>Edit id</wa:mls>">${item.partner.id}</a></td>
					<td class="center category"><a href="${context}/${site}/contentArticle/editItem/id/${item.category.id}.do" title="<wa:mls>Edit id</wa:mls>">${item.category.id}</a></td>
					<td class="center links">
						<a href="${context}/${site}/catalogProductAvailability/catalogProductAvailabilityList.do?s_catalogProduct_id=${item.id}"><wa:mls>availability list</wa:mls></a><br />
						<a href="${context}/${site}/catalogPrice/catalogPriceList.do?s_catalogProduct_id=${item.id}"><wa:mls>prices list</wa:mls></a><br />
					</td>
					<td class="center actions">
