...
<!--floatLeft:end-->
<h2><wa:mls>ContentPerson${waParam.group}</wa:mls></h2>
<div id="list">
	<div id="mask">
		<table cellspacing=0 cellpadding=0>
			...
			<c:forEach var="item" items="${list}" varStatus="loop">
				<tr class="line${((loop.count+1)%2)+1}">
					...
					<td class="center id"><a href="${context}/${site}/contentPerson/editItem/id/${item.id}.do" title="<wa:mls>Edit id</wa:mls>">${item.id}</a></td>
					<td class="center culture">${item.culture}&nbsp;</td>
					<td class="left name">${item.name}&nbsp;</td>
					<td class="center gender">${item.gender}&nbsp;</td>
                    <td class="center language">${item.language}&nbsp;</td>
                    <td class="center company">${item.contentBfoCompany.id}&nbsp;</td>
