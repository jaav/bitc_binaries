			...
			<form name="searchForm" id="searchForm" action="${context}/${site}/${module}/${action}.do${filterString}">  
				...
				<div>
					...
					<wa:include URI="${site}/acxRight/dropList">
						<wa:param name="def" value="${waParam.s_right}"/>
						<wa:param name="selectName" value="s_right"/>
					</wa:include>
				</div> 
				<div>
				...
				<div>
					...
					<wa:include URI="${site}/acxRessource/dropList">
						<wa:param name="def" value="${waParam.s_ressource}"/>
						<wa:param name="selectName" value="s_ressource"/>
					</wa:include>
				</div>
...
<!--floatLeft:end-->
<h2><wa:mls>acxProfileauthorization</wa:mls></h2>
<div id="list">
	<div id="mask">
		<table cellspacing=0 cellpadding=0>
			...
			<c:forEach var="item" items="${list}" varStatus="loop">
				<tr class="line${((loop.count+1)%2)+1}">
					...
					<td class="center id"><a href="${context}/${site}/acxProfileauthorization/editItem/id/${item.id}.do" title="<wa:mls>Edit id</wa:mls>">${item.id}</a></td>
...
<div id="fieldList">
	<div>
		...
		<div>
			<input name="right_" id="c_right_" type="checkbox" value="1" checked="checked"/>
