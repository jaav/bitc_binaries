                ...
                <tr class="header">
                    ...
                    <td class="left url">
                        <wa:link URI="${URI}" allParams="true">
                            ...
                            <wa:param name="orderDir" value="${orderDir}" />
                            <wa:exceptParam name="orderBy"/>
                            <wa:param name="orderBy" value="imageURL" />
                        </wa:link>
                    </td>
                </tr>
                <c:forEach var="item" items="${list}" varStatus="loop">
                    <tr>
                        <td class="center checkbox"><input type="checkbox" value="${item.spotImageId}"></td>
                        <td class="center contentImageId"><a href="${context}/${site}/${module}/editItem/id/${item.spotImageId}.do" title="<wa:mls>Edit id</wa:mls>">${item.spotImageId}</a></td>
                        <td class="left url">${item.imageURL}</td>
                        </td>
                    </tr>
                </c:forEach>
            </table>
