				...
				<div class="bgWhite">
					<label for="f_origin"><wa:mls>origin</wa:mls></label> 
							...
							<select name="f_origin">
								...
								<option value="CLIENT_BNB" <c:if test="${bean.origin=='CLIENT_BNB'}">selected="selected"</c:if>><wa:mls>CLIENT_BNB</wa:mls></option>
							</select>
