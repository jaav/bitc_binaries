					...
					<div class="fl">
						...
						<div id="searchBox">
							...
							<div class="content">
								...
								<div>
									<label for="s_lg"><wa:mls>culture</wa:mls></label>
								...
								<div>
									...
									<input type="checkbox" value="0" name="s_status" <c:if test="${waParams.s_status=='0'}">checked="checked"</c:if>/><wa:mls>NEW</wa:mls>
									<input type="checkbox" value="1" name="s_status" <c:if test="${waParams.s_status=='1'}">checked="checked"</c:if>/><wa:mls>CONFIRMED</wa:mls>
									<input type="checkbox" value="2" name="s_status" <c:if test="${waParams.s_status=='2'}">checked="checked"</c:if>/><wa:mls>BANISHED</wa:mls>					
								</div>
							...
							<table cellspacing=0 cellpadding=0>
								...
								<c:forEach var="item" items="${list}" varStatus="loop">
						            ...
						            >&nbsp;</td>
										...
										<td class="center id"><a href="${context}/${site}/reqforproposalForProfessional/editItem/id/${item.reqid}.do" title="<wa:mls>Edit id</wa:mls>">${item.reqid}</a></td>
										...
										<c:if test="${ac_user_profile eq 'RFP_WITHPRO'}"><td class="center id"><a href="${context}/${site}/${module }/seenBy/reqId/${item.reqid}.do" title="<wa:mls>Viewed By</wa:mls>"><wa:mls>Viewed By</wa:mls></a></td></c:if>
									</tr>
								</c:forEach>
