...
<script type="text/javascript"
	src="${staticSite}/js/SpryValidationTextField.js"></script>
<script type="text/javascript"
	src="${staticSite}/js/SpryValidationRadio.js"></script>
<script type="text/javascript"
	src="${staticSite}/js/SpryValidationPassword.js"></script>
<script type="text/javascript"
	src="${staticSite}/js/SpryValidationConfirm.js"></script>
<script type="text/javascript"
	src="${staticSite}/js/SpryValidationTextarea.js"></script>
<script type="text/javascript"
	src="${staticSite}/js/SpryValidationSelect.js"></script>
<script type="text/javascript"
	src="${staticSite}/js/SpryValidationCheckbox.js"></script>
<link rel="stylesheet" type="text/css"
	href="${staticSite}/css/SpryValidationTextField.css"
	media="screen, projection" />
<link rel="stylesheet" type="text/css"
	href="${staticSite}/css/SpryValidationRadio.css"
	media="screen, projection" />
<link rel="stylesheet" type="text/css"
	href="${staticSite}/css/SpryValidationPassword.css"
	media="screen, projection" />
<link rel="stylesheet" type="text/css"
	href="${staticSite}/css/SpryValidationConfirm.css"
	media="screen, projection" />
<link rel="stylesheet" type="text/css"
	href="${staticSite}/css/SpryValidationTextarea.css"
	media="screen, projection" />
<link rel="stylesheet" type="text/css"
	href="${staticSite}/css/SpryValidationSelect.css"
	media="screen, projection" />
<link rel="stylesheet" type="text/css"
	href="${staticSite}/css/SpryValidationCheckbox.css"
	media="screen, projection" />
<link href="${static}/${site}/css/datepicker.css" rel="stylesheet"
...
<div class="form_search">
	<div>
		...
		<div class="arrow"></div>
		<form action="<wa:url URI="${site}/${module}/display"/>" method="get"
			class="search">

			<input type="hidden" name="group" value="${waParam.group}" /> <input
				type="hidden" name="contentType" value="${contentType}" /> <input
				type="hidden" name="boxOfficeEvent" value="${boxOfficeEvent}" /> <input
				type="text" name="f_search_query" value="${waParam.f_search_query}" />
			<input type="submit" value="<wa:mls>Recherche</wa:mls>"
				class="btn_form" />

			<div class="arrow"></div>
			<c:if
				test="${group ne 'LATEST_NEWS' && group ne 'TESTIMONIAL' && group ne 'DEALS' && group ne 'PRESS_RELEASE'}"> 
				...
				<c:if test="${not empty criteriaDate}">
					...
					<input name="s_periodFromDate" type="text" id="s_periodFromDate"
						class="datepicker" value="${ s_periodFromDate}" />
					<div class="clr"></div>
					...
					<input name="s_periodToDate" type="text" id="s_periodToDate"
						class="datepicker" value="${s_periodToDate}" />
				</c:if>

				<div class="clr"></div>

				<div
					style="<c:if test="${ind == '0'}">display:none</c:if> <c:if test="${ind == '1'}">display:block</c:if>"
					id="advanced_search">
						...
						<c:if test="${fn:toLowerCase(group) ne 'guided_tour'}">
							<div id="ListExperience" class="align_left">
								...
								<wa:include URI="${site}/dropdown/dropList">
									...
									<wa:param name="name"
										value="s_ContentPropertyValueManager_valueId_Experience" />
									<wa:param name="selectedValues"
										value="${waParam.s_ContentPropertyValueManager_valueId_Experience}" />
								</wa:include>
							</div>
							...
							<div id="ListProfiles" class="align_right">
								...
								<wa:include URI="${site}/dropdown/dropList">
									...
									<wa:param name="display" value="mainTitle" />
									<wa:param name="name"
										value="s_ContentPropertyValueManager_valueId_Profil" />
									<wa:param name="selectedValues"
										value="${waParam.s_ContentPropertyValueManager_valueId_Profil}" />
								</wa:include>
							</div>
							<div class="clr"></div>
						</c:if>
					...
					<c:if test="${group eq 'PRESS_RELEASE'}">
						<div id="ListThemes" class="align_left">
							...
							<wa:include URI="${site}/dropdown/dropList">
								...
								<wa:param name="display" value="mainTitle" />
								<wa:param name="name"
									value="s_ContentPropertyValueManager_valueId_Theme" />
								<wa:param name="selectedValues"
									value="${waParam.s_ContentPropertyValueManager_valueId_Theme}" />
							</wa:include>
						</div>
					</c:if>
					...
					<c:if test="${fn:toLowerCase(group) eq 'guided_tour'}">
						<div id="ListCategory" class="align_right">
							...
							<wa:include URI="${site}/dropdown/dropList">
								...
								<wa:param name="display" value="mainTitle" />
								<wa:param name="name"
									value="s_ContentPropertyValueManager_valueId_Category" />
								<wa:param name="selectedValues"
						...
						<div id="ListLanguage" class="align_left">
							...
							<wa:include URI="${site}/dropdown/dropList">
								<wa:param name="class"
									value="com.bitc.utils.ISOLanguageDropdownBean" />
								...
								<wa:param name="selectedValues"
									value="${waParam.s_guided_tour_valueId_language}" />
							</wa:include>
						</div>
					</c:if>
					<c:if
						test="${group eq 'RESTO_1' or group eq 'RESTO_NIGHT' or group eq 'BREAKFAST'}">
						<div class="clr"></div>
						<div id="ListTypeCuisine">
							...
							<wa:include URI="${site}/dropdown/dropList">
								...
								<wa:param name="display" value="mainTitle" />
								<wa:param name="name"
									value="s_ContentPropertyValue_valueId_Cuisine" />
								<wa:param name="selectedValues"
					...
					<c:if test="${group eq 'SHOPPING'}">
						...
						<div id="ListShoppingCategory">
							...
							<wa:include URI="${site}/dropdown/dropList">
								...
								<wa:param name="display" value="mainTitle" />
								<wa:param name="name"
									value="s_ContentPropertyValueManager_valueId_ShoppingCategory" />
								<wa:param name="selectedValues"
					...
					<c:if test="${group eq 'SALES_GUIDE'}">
						...
						<div id="ListSalesGuideCategory">
							...
							<wa:include URI="${site}/dropdown/dropList">
								...
								<wa:param name="display" value="mainTitle" />
								<wa:param name="name"
									value="s_ContentPropertyValueManager_valueId_Sales_guide" />
								<wa:param name="selectedValues"
									value="${waParam.s_ContentPropertyValueManager_valueId_Sales_guide}" />
							</wa:include>
						</div>
					</c:if>
				</div>
...
<script language='javascript'>
	var spryLastname = new Spry.Widget.ValidationTextField("tfv_debut", "none",
			{
				validateOn : [ "blur" ]
			});
	var spryFirstname = new Spry.Widget.ValidationTextField("tfv_fin", "none",
			{
				validateOn : [ "blur" ]
			});
</script>