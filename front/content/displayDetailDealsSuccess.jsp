...
<div id="content_main">
         ...
         <div id="pratical_information_large">
	        <h4><wa:mls>Practical informations</wa:mls></h4>
	         ...
	         <div class="date">
		           		  ...
		           		  <p>	<strong><wa:mls>offre valable entre le </wa:mls></strong>
			            	 ...
			            	 <c:if test="${not empty bean.periodFromDate}">
			            	  <strong><wa:mls>et le:</wa:mls></strong>
	       		 ...
	       		 <p><strong><wa:mls>Nre de participants de</wa:mls></strong>
	       		  	<c:if test="${not empty bean.minParticipants}">
	       		  ${bean.minParticipants} 
	       	      </c:if> 
	       	  	
	       		 <strong><wa:mls>A </wa:mls></strong> 
	       		 <c:if test="${not empty bean.maxParticipants}">
	       		 ${bean.maxParticipants} 
	       	</c:if> 
	      
	    	<div class="clr"></div>
       			<c:if test="${not empty bean.price}">
       			<p><strong><wa:mls>Price :</wa:mls></strong><span class="txt_orange"> ${bean.price}&euro;</span> </p>  
       		</c:if>
       		<div class="clr"></div>
        ...
        <a href="<wa:url URI="${site}/contentDeals/displayForm/id/${bean.id}"/>" class="deals_confirmer_${culture.language}" ></a>  
