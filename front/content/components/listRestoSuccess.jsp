...
<div class="TabbedPanelsContentGroup">
	<ul class="TabbedPanels">
		<li
			class="<c:if test="${panelGroup == 'RESTO'}">TabbedPanelsTabSelected</c:if><c:if test="${panelGroup != 'RESTO'}">TabbedPanelsTab</c:if>">
			<div><a href="<wa:url URI="${site}/content/displayResto/group/RESTO"/>"><wa:mls>Resto</wa:mls></a></div>
		</li>
		<li
			class="<c:if test="${panelGroup == 'BREAKFAST'}">TabbedPanelsTabSelected</c:if><c:if test="${panelGroup != 'BREAKFAST'}">TabbedPanelsTab</c:if>">
			<div><a href="<wa:url URI="${site}/content/displayResto/group/BREAKFAST"/>"><wa:mls>Breakfast</wa:mls></a></div>
		</li>
		<li
			class="<c:if test="${panelGroup == 'RESTO_NIGHT'}">TabbedPanelsTabSelected</c:if><c:if test="${panelGroup != 'RESTO_NIGHT'}">TabbedPanelsTab</c:if>">
			<div><a href="<wa:url URI="${site}/content/displayResto/group/RESTO_NIGHT"/>"><wa:mls>RESTO_NIGHT</wa:mls></a>
			</div>
		</li>
	</ul>
				...
				<li>
					...
					<div class="txt">
						<h3 class="no_margin">
							<a href="<wa:url URI="${site}/content/displayDetail/group/${item.group}/id/${item.id}"/>"
							   title="${item.mainTitle}">${item.mainTitle}</a></h3>
						<c:choose>
					...
					<div class="btn">
						<div class="more_info"><a
							...
							class="btn_more_info" title="${item.mainTitle}"><wa:mls>More info</wa:mls></a></div>
						<c:if
