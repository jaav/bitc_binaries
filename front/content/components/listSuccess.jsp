                ...
                <li>
                    ...
                    <div class="btn">
                        ...
                        <c:if test="${contentType ne 'ContentArticle' and contentType ne 'ContentPress' and not empty item.latitude and item.latitude != 0.0 and not empty item.longitude and item.longitude != 0.0}">
                            <a href="javascript:callLetter('${wa:numberToChar(indexLetter)}', 'map')" class="map"><span><wa:mls>Map :</wa:mls></span><img
                        ...
                        <c:if test="${group ne 'PRESS_REPORT'  and group ne 'OG_TOUR' && group ne 'LATEST_NEWS' && group ne 'TESTIMONIAL' }"><a
                                ...
                                class="add"><img src="${staticSite}/img/ml/btn_add.gif" alt="<wa:mls>Add</wa:mls>"/></a></c:if>
                    </div>
