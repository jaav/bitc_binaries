   ...
   <div class="TabbedPanelsContentGroup">
      ...
      <c:forEach var="item" items="${list}" varStatus="loop">
          ...
          <div class="txt" id="txt_${item.id}">
            <h3 class="no_margin">
            	<a class="url summary" href="<wa:url URI="${site}/content/displayDetail/group/${item.group}/id/${item.id}/boxOfficeEvent/true"/>" title="${item.mainTitle}"> <p class="description">${item.mainTitle}</p>
            	</a>
            </h3>
