...
<div class="float_left mtop10">
	...
	<div id="feature_pratical_information2">
		...
		<c:if
			test="${bean.group ne 'CONTENT' and bean.group ne 'PRESS_REPORT'  and bean.group ne 'OG_TOUR' and bean.group ne 'LATEST_NEWS' and bean.group ne 'PRESTATAIRE'}">
			<a
...
<style type="text/css">
	...
	a.btn_buy_ticket {
		...
		height: 66px;
		outline: none;
		background: url(${buyTicketURL});
		float: left;
	}

	a.btn_buy_ticket:link,
	a.btn_buy_ticket:active,
	a.btn_buy_ticket:visited {
		font-size: 12px;
		line-height: 17px;
		font-family: 'UtopiaStd-Regular', Georgia;
