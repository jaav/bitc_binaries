        	...
        	<c:otherwise>
        		<c:forEach var="item" items="${MeetingPlannerFavoriates}" varStatus="loop">
					<div class="favorite_item"> 
						...
						<a href="javascript:saveMeetingPlannerToDb('${divId}','${contentType}','${item.group}','${item.id}','');" class="btn_add_to_my_trip"><img src="${staticSite}/img/ml/btn_add_my_meeting.jpg" alt="Add my meeting" /></a>
						<div class="clr"></div>
			        </div>
		       </c:forEach>
        	</c:otherwise>
