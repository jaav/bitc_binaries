...
<!--tab:start-->
   ...
   <div class="TabbedPanelsContentGroup">
       ...
       <div class="tab_paging">
            <wa:include URI="${site}/tripPlanner/navNumber"><wa:param name="navId" value="1"/></wa:include>
        <div class="select">
          <form>
            <fieldset>
      ...
      <div class="tab_paging">
        ...
        <wa:include URI="${site}/tripPlanner/navNumber" ><wa:param name="navId" value="2"/></wa:include>
