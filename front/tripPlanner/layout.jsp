...
<div id="nav_trip_planner"> 
	...
	<wa:include URI="front/tripPlanner/myTrip">
		<wa:param name="userId" value="${panelUserId}"/>
	</wa:include>
	<a href="<wa:url URI="${site}/other/print/id/${cryptUserId}"/>" class="btn"><wa:mls>Print your trip</wa:mls></a> 
	 <a  href="http://www.addthis.com/bookmark.php?v=250&amp;username=wanabe" class="addthis_button share btn"  addthis:url="${config['URL']}${context}/${site}/other/print.do?id=${cryptUserId}" addthis:title="<wa:mls>My trip by Visitbrussels</wa:mls>" addthis:description="<wa:mls>Welcome to the official website of the Tourism and convention bureau of Brussels, capital of Europe and Belgium. Discover our hotels, the Brussels museums and attractions, the Belgian gastronomy and venues for your seminars and congresses.</wa:mls>"><wa:mls>Share you trip</wa:mls></a> 
</div>
