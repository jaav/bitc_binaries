...
<!--btnback:start-->
<div id="btn_back_to_result" style="margin-bottom: 15px;"><a href="javascript:history.back();"><wa:mls>Back</wa:mls></a></div>
<!--btnback:end-->
<div class="clear"></div>
<div id="content_main">
	...
	<div id="main_information">
        <div id="box_right_information">	
            ...
            <div id="feature_pratical_information"> 
            	...
            	<a href="http://www.addthis.com/bookmark.php?v=250&amp;username=wanabe" class="addthis_button" id="logo_share" addthis:url="${config['URL']}/${site}/content/displayDetail/group/${item.group}/id/${item.id}.do" addthis:title="${bean.mainTitle}" addthis:description="${fn:replace(wa:html2txt(bean.mainAbstract_),varTmp,'&quot;')}"><img src="${staticSite}/img/ml/btn_share_big.gif" alt="<wa:mls>Share</wa:mls>"/></a>
            </div>
