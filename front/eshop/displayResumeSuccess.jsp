...
<script>
	...
	<INPUT type="hidden" NAME="TITLE" value="<wa:mls>Bitc : eShop</wa:mls>">
	...
	<!-- miscellanous -->
	<INPUT type="hidden" NAME="homeurl" VALUE="${URL}${context}/${site}/splash/display.do">
	<INPUT type="hidden" NAME="catalogurl" VALUE="${URL}${context}/${site}/${module}/displayEsCategory.do">
	<INPUT type="hidden" NAME="CN" value="${order.invoiceLastname} ${order.invoiceFirstname}">
	<INPUT type="hidden" name="EMAIL" value="${order.invoiceEmail}">
	<INPUT type="hidden" NAME="PM" VALUE="">
	<INPUT type="hidden" NAME="BRAND" VALUE="">
	<INPUT type="hidden" NAME="ownerZIP" VALUE="">
	<INPUT type="hidden" NAME="owneraddress" VALUE="${order.invoiceCountry}">
    ...
    <a href="${context}/${site}/${module}/displayFillInfos.do" class="btn_previous_eshop float_left"><wa:mls>Précédent</wa:mls></a> <a href="javascript:sendOgoneForm();" class="btn_next_eshop float_right"><wa:mls>Payer</wa:mls></a>
    <div class="clr"></div>
  </div>
  <!--contentMain:end-->
