...
<script type="text/javascript">
    ...
    var sprytextfield = new Spry.Widget.ValidationTextField("tfv_invoiceStreet", "none", {validateOn:["blur"]});
    var sprytextfield = new Spry.Widget.ValidationTextField("tfv_invoiceNum", "none", {validateOn:["blur"]});
    var sprytextfield = new Spry.Widget.ValidationTextField("tfv_invoiceZipcode", "none", {validateOn:["blur"]});
    var sprytextfield = new Spry.Widget.ValidationTextField("tfv_invoiceCity", "none", {validateOn:["blur"]});
</script>
<div class="clr"></div>
</div>
<!--contentMain:end-->
