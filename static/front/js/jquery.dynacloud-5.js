...
jQuery.fn.dynaCloud = function(outElement) {
 ...
 return this.each(function() {
  ...
  for (var i = 0; i < l; ++i) {
   out.append('<a href="#' + cl[i].el + '" style="font-size: ' + (Math.ceil((cl[i].count / max) * jQuery.dynaCloud.scale)*7) + 'px"><span>' + cl[i].el + '</span></a> &nbsp; ');
  }
  ...
  jQuery('a', out).each(function() {
   jQuery(this).click(function() {
	window.location="http://bitc.wanabe.be/static/front/html_templates/index.html?search="+jQuery(this).text().toLowerCase();
